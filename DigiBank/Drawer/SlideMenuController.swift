...
public struct SlideMenuOptions {
    public static var leftViewWidth: CGFloat = 271.0
...
//                    window.windowLevel = UIWindow.Level.leastNormalMagnitude
//                    window.windowLevel = UIWindow.Level(rawValue: CGFloat(21))
...
//        navigationItem.leftBarButtonItem?.tintColor = ThemeManager.currentTheme().blackWhiteTextColor
    }
...
//        navigationItem.rightBarButtonItem?.tintColor = ThemeManager.currentTheme().blackWhiteTextColor
    }
